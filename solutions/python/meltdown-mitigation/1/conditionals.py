...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    neutron_temp_product = temperature * neutrons_emitted
    if temperature < 800 and neutrons_emitted > 500 and neutron_temp_product < 500000:
        return True
    else:
        return False
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    neutron_temp_product = temperature * neutrons_produced_per_second
    lower_bound = 0.9 * threshold
    upper_bound = 1.1 * threshold
    
    if neutron_temp_product < lower_bound:
        return 'LOW'
    elif neutron_temp_product >= lower_bound and neutron_temp_product <= upper_bound:
        return 'NORMAL'
    else:
        return 'DANGER'
